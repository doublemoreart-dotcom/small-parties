...
const requiredUi = [
  ...
  ['header menu icon asset', /<img[^>]+src=["']assets\/menu-icon\.png["']/],
  ['loading menu icon asset', /class=["']preloader-logo["'][\s\S]*<img[^>]+src=["']assets\/menu-icon\.png["']/],
  ['footer copyright menu icon', /class=["']footer-brand["'][\s\S]*<img[^>]+src=["']assets\/menu-icon\.png["'][\s\S]*© 2026/],
  ['TPP logo asset', /<img[^>]+src=["']assets\/tpp-logo\.png["']/],
  ...
  ['calculator tier insight', /id=["']tierBadge["'][\s\S]*id=["']tierDesc["'][\s\S]*id=["']tierItems["']/],
  ['calculator tier table sync', /data-tier=["']0["'][\s\S]*tier-active-\$\{index\}[\s\S]*scrollToActiveTier/],
